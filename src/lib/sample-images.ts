/** Curated Unsplash imagery for Fore Beyond marketing & placeholders */
...
export const sampleImages = {
  ...
  /** Search families page hero — welcoming travelers, not food imagery */
  searchFamilies:
  ...
  familyDinner: "/hero-family-guest.png",
  hiking:
