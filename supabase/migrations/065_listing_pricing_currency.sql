-- Host listing rates are entered and stored in the host's local pricing currency
ALTER TABLE host_listings
  ADD COLUMN IF NOT EXISTS pricing_currency TEXT NOT NULL DEFAULT 'USD';

ALTER TABLE host_listings
  DROP CONSTRAINT IF EXISTS host_listings_pricing_currency_check;

ALTER TABLE host_listings
  ADD CONSTRAINT host_listings_pricing_currency_check
