-- Fore Beyond Phase 6: Request Stay Flow (combined setup)
-- Run with: npm run db:phase6
...
DROP POLICY IF EXISTS "Participants can view stay bookings" ON stay_bookings;
...
DROP POLICY IF EXISTS "System creates stay bookings via participants" ON stay_bookings;
...
DROP POLICY IF EXISTS "Participants can update stay bookings" ON stay_bookings;
